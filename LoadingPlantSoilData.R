...
spcomp4$Diversity<-diversity(spcomp4[,5:51], index="shannon")
spcomp4$Evenness<-spcomp4$Diversity/log(spcomp4$Richness)
spcomp4$NatAbun<-rowSums(spcomp4[,6:51])
spcomp4$NatRichness<-rowSums(spcomp4[,6:51]>0)
spcomp4$NatDiversity<-diversity(spcomp4[,6:51], index="shannon")
spcomp4$NatEvenness<-spcomp4$NatDiversity/log(spcomp4$NatRichness)
